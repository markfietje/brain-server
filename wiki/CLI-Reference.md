...
- **[API Reference](API-Reference)** — the same surface over HTTP.
- **[Client GUI](Client-GUI)** — the same surface as a visual app.
- **[Quickstart](Quickstart)** — a working end-to-end example.
