...
- **[Installation](Installation)** — applying these in practice.
- **[Security](Security)** — how the auth variables work together.
- **[API Reference](API-Reference)** — the contract those configs gate.
