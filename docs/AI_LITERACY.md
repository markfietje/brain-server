...
**Artifact for:** `COMPLIANCE.md` §6.4 · **Applies to:** brain-server 1.28.92
· **Last updated:** 2026-09-22 (mechanism-level playbook — proposal gate, quarantine, DSAR, keyed chain — re-verified unchanged through .92)
