...
[![Version](https://img.shields.io/badge/version-1.28.82-blue.svg)](#)
...
[![Tests](https://img.shields.io/badge/tests-1526%20passed-brightgreen.svg)](#)
...
* 1,523 tests passed, `cargo fmt` and `clippy -D warnings` clean
