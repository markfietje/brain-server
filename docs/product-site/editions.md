...
- **Profiles/SSE**: planned (Profiles) + SSE push is roadmap-deferred; **OTel shipped** feature-gated in v1.20.7 (`--features otel`, opt-in via `BRAIN_OTEL_ENABLED`/`BRAIN_OTEL_ENDPOINT`). See **[Observability](../observability.md)**.
