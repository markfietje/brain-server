...
- **[Client GUI](Client-GUI)** — the full panel reference.
- **[Universal Memory Protocol](Universal-Memory-Protocol)** — the wire surface the UMP panel drives.
- **[Governance & Compliance](Governance-and-Compliance)** — the rights/retention surface Data exposes.
